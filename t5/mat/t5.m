...
figure;
semilogx(f, angle(Ts), 'g');
xlabel ("f (Hz)");
ylabel ("Frequency Response Phase (degrees)");
title ("Frequency Response")
print ("fresponse2.eps");
...
fprintf(fid, "Input Impedance & %e + %e i\\\\ \\hline \n", real(ZI), imag(ZI));
fprintf(fid, "Output Impedance & %e + %e i\\\\ \n", real(ZO), imag(ZO));
fclose (fid);
